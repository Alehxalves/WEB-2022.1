...
function SignUp(props) {
  ...
  const validateFields = () => {
    ...
    if (password !== repassword) {
      props.setToast({ header: "Error!", body: "Repeat the same password!" });
  ...
  return (
    <div className="content__autentication" style={{ marginTop: 50 }}>
      <main style={{ width: "40%", alignContent: "center" }}>
        <h2>Sign Up</h2>
      ...
      <nav>
        <Link to="/signIn" className="nav-button" style={{ fontWeight: "bold", textDecoration:'none' }}>
          Sign In
        </Link>
      </nav>
    </div>
